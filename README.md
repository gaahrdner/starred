...
- [ScholarXIV/ScholarXIV-App](https://github.com/ScholarXIV/ScholarXIV-App) - ScholArxiv is an open-source, aesthetic, minimal and AI powered app that allows users to search, read, bookmark, share, download and view summaries of academic papers from the arXiv repository.
...
- [minhnv0807/ai-business-skills](https://github.com/minhnv0807/ai-business-skills) - 60 production-ready AI marketing skills (29 VN + 30 Global) for Claude Code, ChatGPT, Gemini & Copilot. 4 regions (US/EU/SEA/LATAM), Personal Brand + AI Avatar cluster, Dropshipping flagship for US/EU
...
- [theoddden/Terradev](https://github.com/theoddden/Terradev) - An imperative language for AI workload orchestration
...
- [volotat/Anagnorisis](https://github.com/volotat/Anagnorisis) - Completely local data-management platform with built in trainable recommendation engine
