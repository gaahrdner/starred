...
- [OpenAdaptAI/OpenAdapt](https://github.com/OpenAdaptAI/OpenAdapt) - AI-First Process Automation with Large [Language Models (LLMs) / Action Models (LAMs) / Multimodal Models (LMMs)] / Visual Language Models (VLMs)
