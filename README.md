...
- [MartinGalway/C64_music](https://github.com/MartinGalway/C64_music) - Music source files from 1980's Commodore 64 games
- [netzherpes/KIM1-Demo](https://github.com/netzherpes/KIM1-Demo) - a little demo for the KIM-1 for it's 50th birthday
...
- [dale-lakes/MegaDev](https://github.com/dale-lakes/MegaDev) - Bro IDS + ELK Stack to detect and block data exfiltration

## C 

- [elyosh/OpenTIE](https://github.com/elyosh/OpenTIE) - 
...
- [Semperis/SAMLSmith](https://github.com/Semperis/SAMLSmith) - 
...
- [NullPxl/banrays](https://github.com/NullPxl/banrays) - Glasses to detect smart-glasses that have cameras. Ray-BANNED
...
- [hjd1964/OnStepX](https://github.com/hjd1964/OnStepX) - 
...
- [dkyazzentwatwa/project-starbeam](https://github.com/dkyazzentwatwa/project-starbeam) - The Ultimate ESP32 Jammer w/ 5 Radios.  #RIPflipper -- V2 OUT NOW
...
- [ScholarXIV/OpenScholarXIV](https://github.com/ScholarXIV/OpenScholarXIV) - OpenScholarXIV is an open-source, aesthetic, minimal and AI powered app that allows users to search, read, bookmark, share, download and view summaries of academic papers from the arXiv repository.
...
- [Jamsers/Bistro-Demo-Tweaked](https://github.com/Jamsers/Bistro-Demo-Tweaked) - Bistro demo project for Godot showcasing lighting and high quality assets.
...
- [asteroid-belt/skulto](https://github.com/asteroid-belt/skulto) - Offline and security-first tool for syncing and managing agent skills
- [spiffe/spiffe-step-ssh](https://github.com/spiffe/spiffe-step-ssh) - Issue SSH host certificates using SPIFFE
- [loresuso/psc](https://github.com/loresuso/psc) - the ps utility, with an eBPF twist and container context
...
- [0x48piraj/gz-bomb](https://github.com/0x48piraj/gz-bomb) - Web-based "Zip bomb" which eats up all the memory and kills web browsers, scanners and bots.
...
- [Azure/peerd](https://github.com/Azure/peerd) - Peer to peer distribution of Azure Artifact Streaming.
...
- [mlange-42/arche](https://github.com/mlange-42/arche) - Arche -- Archetype-based Entity Component System (ECS) for Go.
- [treeverse/lakeFS](https://github.com/treeverse/lakeFS) - lakeFS - Data version control for your data lake | Git for data
- [Zouuup/landrun](https://github.com/Zouuup/landrun) - Run any Linux process in a secure, unprivileged sandbox using Landlock. Think firejail, but lightweight, user-friendly, and baked into the kernel.
- [teivah/100-go-mistakes](https://github.com/teivah/100-go-mistakes) - 📖 100 Go Mistakes and How to Avoid Them
- [rudransh61/Physix-go](https://github.com/rudransh61/Physix-go) - A simple Physics engine in GoLang
...
- [noperator/siftrank](https://github.com/noperator/siftrank) - Use LLMs to rank anything
...
- [soub4i/kubestatus-operator](https://github.com/soub4i/kubestatus-operator) - kubestatus operator
- [IceWhaleTech/CasaOS](https://github.com/IceWhaleTech/CasaOS) - CasaOS - A simple, easy-to-use, elegant open-source Personal Cloud system.
- [cyclops-ui/cyclops](https://github.com/cyclops-ui/cyclops) - Developer Friendly Kubernetes 👁️
- [chenquan/sqltrace](https://github.com/chenquan/sqltrace) - A low-code intrusion library that provides SQL tracing capabilities, suitable for any relational database (Sqlite3, MySQL, Oracle, SQL Server, PostgreSQL, TiDB, TDengine, etc.) and ORM libraries for v
...
- [sinkingpoint/clogger](https://github.com/sinkingpoint/clogger) - A Logging Daemon
...
- [yuuki/shawk](https://github.com/yuuki/shawk) - [PoC]  A socket-based tracing system for discovering network service dependencies. (renamed from transtracer)
...
- [naughtygopher/pocache](https://github.com/naughtygopher/pocache) - Pocache is a minimal cache package which focuses on a preemptive optimistic caching strategy
...
- [tjb/gofaux](https://github.com/tjb/gofaux) - versatile cli tool that captures and stores json requests, allowing you to replay them as needed.
...
- [knl/pulley](https://github.com/knl/pulley) - A service to expose Prometheus metrics of your CI’s validation of Pull Requests, using GitHub webhooks.
...
- [HumanSecurity/marshmallow](https://github.com/HumanSecurity/marshmallow) - Marshmallow provides a flexible and performant JSON unmarshalling in Go. It specializes in dealing with unstructured struct - when some fields are known and some aren't, with zero performance overhead
...
- [stephenlacy/daz](https://github.com/stephenlacy/daz) - Composable HTML components in Golang
...
- [target/flottbot](https://github.com/target/flottbot) - ARCHIVED! A chatbot framework written in Go. All configurations are made in YAML files, or inside scripts written in your favorite language.
...
- [go-furnace/go-furnace](https://github.com/go-furnace/go-furnace) - Go Hosting Solution for AWS, Google Cloud and Digital Ocean
...
- [jiusanzhou/surferua](https://github.com/jiusanzhou/surferua) - High-performance Go library for generating realistic HTTP User-Agent strings — device-type aware, ideal for scrapers.
...
- [kf0jvt/deez_factors](https://github.com/kf0jvt/deez_factors) - Looks for GitHub org users without 2FA turned on
...
- [cloudposse-archives/terraform-aws-jenkins](https://github.com/cloudposse-archives/terraform-aws-jenkins) - Terraform module to build Docker image with Jenkins, save it to an ECR repo, and deploy to Elastic Beanstalk running Docker stack
...
- [mthiim/dilithium-java](https://github.com/mthiim/dilithium-java) - Experimental Java implementation of post-quantum crypto algorithm Dilithium (including JCE provider)
...
- [gojiplus/notary](https://github.com/gojiplus/notary) - PyPI Attestation Shield Generation Service
...
- [ngacho/emaillm](https://github.com/ngacho/emaillm) - 
...
- [cloudflare/doom](https://github.com/cloudflare/doom) - Website and Message Router source code for the Multiplayer Doom on Cloudflare Workers tech demo
...
- [BuffaloWill/Serpico](https://github.com/BuffaloWill/Serpico) - SimplE RePort wrIting and COllaboration tool
...
- [ReversecLabs/dref](https://github.com/ReversecLabs/dref) - DNS Rebinding Exploitation Framework
...
- [microsoft/edgeai-for-beginners](https://github.com/microsoft/edgeai-for-beginners) - This course is designed to guide beginners through the exciting world of Edge AI, covering fundamental concepts, popular models, inference techniques, device-specific applications, model optimization,
...
- [intellectronica/building-effective-agents-with-pydantic-ai](https://github.com/intellectronica/building-effective-agents-with-pydantic-ai) - Code examples for Building Effective Agents ported and adapted to use Pydantic AI
- [sthalles/SimCLR](https://github.com/sthalles/SimCLR) - PyTorch implementation of SimCLR: A Simple Framework for Contrastive Learning of Visual Representations
...
- [night-chen/ToolQA](https://github.com/night-chen/ToolQA) - ToolQA, a new dataset to evaluate the capabilities of LLMs in answering challenging questions with external tools. It offers two levels (easy/hard) across eight real-life scenarios.
- [artidoro/qlora](https://github.com/artidoro/qlora) - QLoRA: Efficient Finetuning of Quantized LLMs
- [Road-Balance/SpotMicroJetson](https://github.com/Road-Balance/SpotMicroJetson) - Let's make SpotMicro with Nvidia Jetson Nano.
...
- [Sirozha1337/storytellersync.koplugin](https://github.com/Sirozha1337/storytellersync.koplugin) - KOReader plugin to sync progress with Storyteller app
...
- [jmfriedt/NISAR_pbr](https://github.com/jmfriedt/NISAR_pbr) - Passive Bistatic RADAR using the spaceborne NISAR satellite signal
...
- [nix-community/gomod2nix](https://github.com/nix-community/gomod2nix) - Convert applications using Go modules to Nix expressions [maintainer=@marcusramberg]
...
- [ScarlettSparks/KnittingMachine](https://github.com/ScarlettSparks/KnittingMachine) - 
...
- [oblique-security/saml-research](https://github.com/oblique-security/saml-research) - SAML hacking pipeline for Claude Code
...
- [TheRobotStudio/robot-nano-hand](https://github.com/TheRobotStudio/robot-nano-hand) - Just add 3d printer for an AI powered robot hand
...
- [beetrove/openai-gpts-data](https://github.com/beetrove/openai-gpts-data) - Data about 349K OpenAI Custom GPTs
...
- [sb-ocr/pi-terminal](https://github.com/sb-ocr/pi-terminal) - 3D printed CRT-style Raspberry Pi enclosure
...
- [mala-lab/ADBenchmarks-anomaly-detection-datasets](https://github.com/mala-lab/ADBenchmarks-anomaly-detection-datasets) - ADRepository: Real-world anomaly detection datasets, including tabular data (categorical and numerical data), time series data, graph data, image data, and video data.
...
- [tjiahen/awesome-WebVR](https://github.com/tjiahen/awesome-WebVR) - A curated list of awesome WebVR packages and resources.
...
- [LittleGreenViper/LGV_TZ_Lookup](https://github.com/LittleGreenViper/LGV_TZ_Lookup) - Server for Matching Long/Lat to Timezone
...
- [snoopysecurity/Broken-Vulnerable-Code-Snippets](https://github.com/snoopysecurity/Broken-Vulnerable-Code-Snippets) - A small collection of vulnerable code snippets
...
- [markmal/freeship-plus-in-lazarus](https://github.com/markmal/freeship-plus-in-lazarus) - FreeShip Plus in Lazarus
...
- [raymondlo84/nvidia-jetson-ai-monitor](https://github.com/raymondlo84/nvidia-jetson-ai-monitor) - An example development repository for using Nvidia Jetson Nano or Xavier as health monitor using computer vision.
...
- [togethercomputer/aurora](https://github.com/togethercomputer/aurora) - 
- [OWASP/APTS](https://github.com/OWASP/APTS) - OWASP Autonomous Penetration Testing Standard
- [Applied-Compute/trie](https://github.com/Applied-Compute/trie) - Lightweight harness for replaying inference traffic against an endpoint
...
- [sector07-dev/ALG-1-Photobioreactor](https://github.com/sector07-dev/ALG-1-Photobioreactor) - ALG-1 is a controlled photobioreactor designed for the cultivation of edible microalgae, specifically spirulina (Arthrospira Platensis). The system was developed to explore closed-loop nutrient genera
...
- [nehzux/DivideConquerAgents](https://github.com/nehzux/DivideConquerAgents) - [ICLR 2026] When Does Divide and Conquer Work for Long Context LLM? A Noise Decomposition Framework
...
- [knostic/OpenAnt](https://github.com/knostic/OpenAnt) - OpenAnt from Knostic is the leading open source LLM-based vulnerability discovery product, helping defenders proactively find verified security flaws while minimizing both false positives and false ne
...
- [WeModulate/bitwig-mcp-server](https://github.com/WeModulate/bitwig-mcp-server) - MCP Server for Bitwig Studio
...
- [VsonicV/es-at-scale](https://github.com/VsonicV/es-at-scale) - This repo contains the source code for the paper "Evolution Strategies at Scale: LLM Fine-Tuning Beyond Reinforcement Learning"
- [cased/sandboxes](https://github.com/cased/sandboxes) - Universal API for cloud sandboxes + CLI
...
- [kaushikb11/verifiers-monitor](https://github.com/kaushikb11/verifiers-monitor) - Observability framework for RL training and evaluation
...
- [herniqeu/extract0](https://github.com/herniqeu/extract0) - Extract-0: A Specialized Language Model for Document Information
...
- [finite-sample/rmcp](https://github.com/finite-sample/rmcp) - R MCP Server
- [The-AI-Alliance/deep-research-agent-for-applications](https://github.com/The-AI-Alliance/deep-research-agent-for-applications) - Example apps that explores the challenges of building production-quality AI applications.
...
- [ExMachinaParlor/Tengu-Marauder](https://github.com/ExMachinaParlor/Tengu-Marauder) - The Tengu Maruader is an open source wireless testing and autonomous security robot designed for multi-terrain movement and meant to work in tandem with the Strix Interceptor
...
- [lucidrains/neat](https://github.com/lucidrains/neat) - Explorations into NEAT and some of its derivative research
...
- [ezztahoun/attack_flow_detector](https://github.com/ezztahoun/attack_flow_detector) - Find relevant incidents, logs, events, and alerts to all of your incidents. [Attack Flows, Attack Chains, & Root Cause Discovery - NO LLMs, NO Queries, Just Explainable Machine Learning] &gt;&gt; Use 
...
- [sourmash-bio/sourmash](https://github.com/sourmash-bio/sourmash) - Quickly search, compare, and analyze genomic and metagenomic data sets.
...
- [Messi-Q/AMEVulDetector](https://github.com/Messi-Q/AMEVulDetector) - Smart Contract Vulnerability Detection From Pure Neural Network to Interpretable Graph Feature and Expert Pattern Fusion (IJCAI-21 Accepted)
...
- [Anilturaga/aiide](https://github.com/Anilturaga/aiide) - Pragmatic framework to build LLM Copilots
...
- [Thytu/Agentarium](https://github.com/Thytu/Agentarium) - open-source framework for creating and managing simulations populated with AI-powered agents. It provides an intuitive platform for designing complex, interactive environments where agents can act, le
...
- [lucidrains/coconut-pytorch](https://github.com/lucidrains/coconut-pytorch) - Implementation of 🥥 Coconut, Chain of Continuous Thought, in Pytorch
...
- [apple-aiml-research/ml-aim](https://github.com/apple-aiml-research/ml-aim) - This repository provides the code and model checkpoints for AIMv1 and AIMv2 research projects.
...
- [volotat/Anagnorisis](https://github.com/volotat/Anagnorisis) - Local data-management platform with built-in trainable recommendation engine and distributed file-sharing ecosystem for content search and discovery.
...
- [adamkarvonen/chess_llm_interpretability](https://github.com/adamkarvonen/chess_llm_interpretability) - Visualizing the internal board state of a GPT trained on chess PGN strings, and performing interventions on its internal board state and representation of player Elo.
...
- [Quitten/Autorize](https://github.com/Quitten/Autorize) - Automatic authorization enforcement detection extension for burp suite written in Jython developed by Barak Tawily in order to ease application security people work and allow them perform an automatic
...
- [neuml/paperetl](https://github.com/neuml/paperetl) - 📄 ⚙️ ETL processes for medical and scientific papers
...
- [saulpw/aipl](https://github.com/saulpw/aipl) - Array-Inspired Pipeline Language
...
- [rnanosaur/nanosaur](https://github.com/rnanosaur/nanosaur) - 🦕 nanosaur is a little robot, powered by ROS 2. Made for NVIDIA Jetson
...
- [princeton-nlp/MeZO](https://github.com/princeton-nlp/MeZO) - [NeurIPS 2023] MeZO: Fine-Tuning Language Models with Just Forward Passes. https://arxiv.org/abs/2305.17333
...
- [joshwallerr/newsnotfound](https://github.com/joshwallerr/newsnotfound) - Entire source code for NewsNotFound's article generation process ✍
...
- [kmeng01/memit](https://github.com/kmeng01/memit) - Mass-editing thousands of facts into a transformer memory (ICLR 2023)
- [jostmey/msm](https://github.com/jostmey/msm) - Improved statistical classifier for immune repertoires
...
- [OwenElliottDev/SpeechSearch](https://github.com/OwenElliottDev/SpeechSearch) - 
...
- [stringertheory/traces](https://github.com/stringertheory/traces) - A Python library for unevenly-spaced time series analysis
...
- [YelpArchive/clusterman](https://github.com/YelpArchive/clusterman) - Cluster Autoscaler for Kubernetes and Mesos
...
- [barnumbirr/ares](https://github.com/barnumbirr/ares) - A python wrapper around https://vulnerability.circl.lu.
...
- [chrismattmann/meridian](https://github.com/chrismattmann/meridian) - Point it at a corpus. Cut it on concept, place, and time.
...
- [hyperb1iss/uchroma](https://github.com/hyperb1iss/uchroma) - An advanced driver for Razer Chroma hardware in Linux with multi-layer animation support
...
- [joshenders/dnsdiff](https://github.com/joshenders/dnsdiff) - DNS migration tool which helps validate a new provider
...
- [kinduff/dogapi.dog](https://github.com/kinduff/dogapi.dog) - Provides information on over 340 dog breeds, 20 breed groups, and fun facts.
...
- [d2iq-archive/marathon-lb-autoscale](https://github.com/d2iq-archive/marathon-lb-autoscale) - Autoscale your apps on Marathon
...
- [logannye/rosalind](https://github.com/logannye/rosalind) - Deterministic, resource-governed per-locus genomics analyses with transactional artifacts, receipts, replay, Arrow, and reproducible sharding.
...
- [CrowdStrike/lex_sleuther](https://github.com/CrowdStrike/lex_sleuther) - Sleuth out script languages by lexing.
...
- [pramatias/documentdf](https://github.com/pramatias/documentdf) - 
...
- [Park07/amradio](https://github.com/Park07/amradio) - 

## Scala 

- [data-catering/data-caterer](https://github.com/data-catering/data-caterer) - Test data management tool for any data source, batch or real-time. Generate, validate and clean up data all in one tool.
...
- [skrzyp/hoopy](https://github.com/skrzyp/hoopy) - Cold and well-together way of making just enough system images. Alpine Linux Inside.
- [cyberasset/asset-inventory](https://github.com/cyberasset/asset-inventory) - Asset inventory of over 800 public bug bounty programs.
...
- [egen/concourse-pullrequest-playtime](https://github.com/egen/concourse-pullrequest-playtime) - 
...
- [cloud-gov/pipeline-tasks](https://github.com/cloud-gov/pipeline-tasks) - Concourse common tasks
...
- [ErichDylus/Open-Source-Legal-Engineering](https://github.com/ErichDylus/Open-Source-Legal-Engineering) - open source legal templates, solidity smart contracts, and scripts for incentive programmers
...
- [prime-radiant-inc/superpowers-evals](https://github.com/prime-radiant-inc/superpowers-evals) - Behavioral eval lab (Quorum) for the superpowers project that drives real coding-agent CLIs (Claude, Codex, Gemini, Kimi, and more) through a QA agent and grades them on workflow compliance against sc
...
- [therandomsecurityguy/khalifa](https://github.com/therandomsecurityguy/khalifa) - Agentless ingestion of AWS Org resources and Security Hub findings into a Neptune-backed security graph, with a risk and attack-path engine to identify security issues.
...
- [tuliperis/SharkMCP](https://github.com/tuliperis/SharkMCP) - A tshark MCP server for packet capture and analysis
- [mapbox/mcp-server](https://github.com/mapbox/mcp-server) - Mapbox Model Context Protocol (MCP) server
- [T3-Content/SnitchBench](https://github.com/T3-Content/SnitchBench) - 
...
- [LLemonStack/llemonstack](https://github.com/LLemonStack/llemonstack) - All-in-one local low-code AI agent development platform. Installs and runs n8n, Flowise, Browser-Use, Qdrant, Ollama, and more. Proxies LLM requests through LiteLLM with Langfuse for observability.
...
- [EvolvingAgentsLabs/evolving-agents](https://github.com/EvolvingAgentsLabs/evolving-agents) - Your toolkit for autonomous, evolving agent ecosystems. Create, execute, govern, and evolve agents that learn from experience, collaborate, build new capabilities, and operate safely within defined gu
...
- [palico-ai/palico-ai](https://github.com/palico-ai/palico-ai) - Build, Improve Performance, and Productionize your AI Application
...
- [qpwo/actual-malware](https://github.com/qpwo/actual-malware) - Just npm install
...
- [OutlineFoundation/shadowsocksconfig](https://github.com/OutlineFoundation/shadowsocksconfig) - Serialize Shadowsocks configuration data to and from SIP002 and legacy URI formats.
...
- [sapran/nmap-xsl](https://github.com/sapran/nmap-xsl) - Various XSL templates to manipulate data from NMap XML reports
...
- [0xAnalyst/WebshellDetectionWMIYara](https://github.com/0xAnalyst/WebshellDetectionWMIYara) - WebShell Detection Through Yara and Powershell WMI Event Subscription
