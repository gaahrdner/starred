...
- [RogueMaster/awesome-flipperzero-withModules](https://github.com/RogueMaster/awesome-flipperzero-withModules) - A collection of awesome resources & modules for the Flipper Zero device.
...
- [maxritter/diy-thermocam](https://github.com/maxritter/diy-thermocam) - A do-it-yourself thermal imager, based on the popular FLIR Lepton LWIR sensor and an Arduino compatible Teensy 4.1 microcontroller
...
- [OpenAdaptAI/OpenAdapt](https://github.com/OpenAdaptAI/OpenAdapt) - AI-First Process Automation with Transformers
...
- [ErikBjare/are-copilots-local-yet](https://github.com/ErikBjare/are-copilots-local-yet) - Are Copilots Local Yet? Explore the frontier of local LLM Copilots for code completion, project generation, shell assistance, and more. Uncover the tools and trends shaping tomorrow's developer experi
...
- [linear-b/gitstream](https://github.com/linear-b/gitstream) - /:\ gitStream - Workflow automation for the code review process. Use YAML to automatically assign reviewers, apply PR labels, auto-merge PRs, and more.
...
- [agi-merge/waggle-dance](https://github.com/agi-merge/waggle-dance) - Waggle Dance is a general goal-solver powered by an AI Agent swarm implementing Plan-Validate-Solve.
